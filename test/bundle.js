...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  ListItem: __webpack_require__(3)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	List = React.createClass({
	    ...
	    listItems = this.state.listItems.map((function(_this) {
	      return function(item, index) {
	        return React.createElement(ListItem, {
	          ...
	          "value": item,
	          "onChange": _this._handleChangeItem.bind(_this, index),
	          "onRemove": _this._handleRemoveItem.bind(_this, index)
	        });
	      };
	    })(this));
	    return React.createElement("div", {
	      "className": "list"
	    }, React.createElement("ol", null, listItems.toJS()), React.createElement("input", {
	  ...
	  _handleChangeItem: function(index, newValue) {
	    return this.setState({
	      listItems: this.state.listItems.set(index, newValue)
	    });
	  },
	  _handleRemoveItem: function(index, ev) {
	    return this.setState({
...
/***/ function(module, exports, __webpack_require__) {
	...
	ListItem = React.createClass({
	  ...
	  render: function() {
	    var substring, value;
	    substring = this.props.value.substr(0, this.props.inputValue.length);
	    if (this.props.inputValue.length > 0 && this.props.inputValue === substring) {
	      value = React.createElement("span", null, React.createElement("span", null, this.props.value.substr(0, this.props.inputValue.length)), this.props.value.substr(this.props.inputValue.length));
	    } else {
	      value = React.createElement("span", null, this.props.value);
	    }
	  ...
	  _onKeyDown: function(ev) {
	    if (ev.keyCode === 13 || ev.keyCode === 9) {
	      if (this.state.newValue === this.props.value) {
	        ...
	        return this.props.onChange(this.state.newValue);
	      }
	    }
	  },
